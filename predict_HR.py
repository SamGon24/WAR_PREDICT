...
model = joblib.load("HR_predictor_model.pkl")
...
while True:
    ...
    if player_data.empty:
        ...
        # Predict WAR
        predicted_HR = model.predict(player_scaled)[0]

        print(f"Predicted HRs for {player_name} (based on most recent season): {predicted_HR:.2f}")
